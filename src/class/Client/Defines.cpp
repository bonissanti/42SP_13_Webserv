...
string Client::defineFilePath(Route& route, string uri)
{
    ...
    else if (!Utils::fileExists(temp))
    {
        ...
        //     if (route.getIndex().find(".html") != string::npos || route.getIndex().find(".php") != string::npos || route.getIndex().find(".py") != string::npos) {
        //         size_t found = 0;
        //         if (route.getIndex().find(".html") != string::npos)
        //             found = route.getIndex().find(".php");
        //         else if (route.getIndex().find(".php") != string::npos)
        //             found = route.getIndex().find(".php");
